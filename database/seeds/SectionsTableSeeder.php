...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Section::updateOrCreate(['id' => 160], ['name' => 'admin_webinar_notification_to_students', 'section_group_id' => 150, 'caption' => 'Send notification to course students']);
        Section::updateOrCreate(['id' => 161], ['name' => 'admin_webinar_statistics', 'section_group_id' => 150, 'caption' => 'Course statistics']);
        Section::updateOrCreate(['id' => 162], ['name' => 'admin_agora_history_list', 'section_group_id' => 150, 'caption' => 'Agora history lists']);
        Section::updateOrCreate(['id' => 163], ['name' => 'admin_agora_history_export', 'section_group_id' => 150, 'caption' => 'Agora history export']);
        Section::updateOrCreate(['id' => 164], ['name' => 'admin_course_question_forum_list', 'section_group_id' => 150, 'caption' => 'Forum Question Lists']);
        Section::updateOrCreate(['id' => 165], ['name' => 'admin_course_question_forum_answers', 'section_group_id' => 150, 'caption' => 'Forum Answers Lists']);
